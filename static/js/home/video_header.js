    ...
    var appendTeaserVideo = function() {
        if(Modernizr.video && !isMobile()) {
            var source = videoDetails.teaser,
                ...
                html = '<iframe id="video" src="http://www.youtube.com/embed/'+source+'?version=3&sound=0&hd=1&controls=0&showinfo=0&autoplay=1&iv_load_policy=3&loop=1&playlist='+source+'"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
                //html = '<iframe id="video" src="http://www.youtube.com/embed/'+source+'?rel=0&amp;hd=1&autohide=1&showinfo=0&autoplay=1&enablejsapi=1&origin=*" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
